  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" method="POST" style="margin-right: 20px;">
        <select class="form-control" name="tipo" style="margin-right:20px ;">
          <option selected value="0">Sem filtro</option>
          <option value="1">Fornecedor</option>
          <option value="2">Categoria</option>
        </select>
      <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="psq">
